...
ROLES = ROLES or {
    ...
    DIVISION_501STRECRUIT = {
        ...
        Description = "The 501st specializes in ground-to-ground combat. These frontline soldiers deploy heavy weaponry, deflector shields, and armored powersuits to become a bulwark against the enemy.",
        Default = true,
        Ranks = {
    ...
    DIVISION_212THRECRUIT = {
		...
		Type = "212th",
        Description = "The 212th Attack Battalion takes the fight to the skies thanks to their specialized training in the use of jetpacks and aerial combat. They are the first into the fight, flanking and assaulting enemy positions from unexpected angles. They also specialize in demolitions and explosives.",
        Default = true,
